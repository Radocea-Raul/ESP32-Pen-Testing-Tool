...
SPIClass vspi(VSPI);
// radio(CE, CS)
RF24 radio(27, 15, 16000000);   // Radio 1 (Conform PCB-ului tau: CE=Pin11, CSN=Pin35)
RF24 radio2(26, 25, 16000000);  // Radio 2 (Conform PCB-ului tau: CE=Pin10, CSN=Pin9)
RF24 radio3(17, 5, 16000000);   // Radio 3 (Conform PCB-ului tau: CE=Pin29, CSN=Pin30)
...
#define LED_PIN 16
// Buttons
#define UP_BUTTON_PIN 14     // Pin 12 Fizic
#define DOWN_BUTTON_PIN 12   // Pin 13 Fizic
#define SELECT_BUTTON_PIN 13 // Pin 15 Fizic (Verifica daca e 13 sau 15, ai zis 15 inainte, dar in cod era 13. Lasam 13 daca asa ai pus).
...
void initRadios() {
  ...
  // Folosim pinii standard VSPI (SCK=18, MISO=19, MOSI=23) care sunt pe PCB-ul tau
  vspi.begin(); 
...
void initDisplay() {
  // Aici a fost modificat Setup-ul in functia principala, nu aici.
